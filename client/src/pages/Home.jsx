...
const Home = () => {
  ...
  return (
    ...
    <h1 class='text-white flex-auto text-xl font-semibold text-center'>Welcome to DAprOd (NOTICE: This a Test version live on Goerli-testnet)</h1>
    <p class='text-white text-center'>Be the producer of what you want to see</p>
    <p class='text-white text-center'>What is DAprOd project?</p>
    <div class='mt-5'><center><iframe width="100%" height="300px" src="https://www.youtube.com/embed/cO3_rnP4UYg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></center></div> 
  </div>
  ...
  <div class="flex flex-col m-10">
    ...
    <div class="flex flex-wrap justify-center m-10 md:w-full text-white">
      <div class="w-full lg:w-1/2 p-2">
        <div class="mt-5 mx-5">
          <img src="./public/img/JB_300x300.png" alt="" class="rounded-bl-3xl rounded-tr-3xl" /> <br />
          <h2>Jean-Baptiste</h2>
          <p>Bio</p>
        </div>
      </div>
      <div class="w-full lg:w-1/2 p-2">
        <div class="mt-5 mx-5">
          <img src="./public/img/adyl-pfp.png" alt="" class="rounded-bl-3xl rounded-tr-3xl" /><br />
          <h2>Adyl ITTO</h2>
